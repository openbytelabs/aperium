...
```bash
git clone https://github.com/openbytelabs/aperium
```
...
For more information, please check out the [official repository](https://github.com/openbytelabs/aperium) or run `aper help` in your terminal.
